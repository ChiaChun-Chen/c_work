...
/*
    ...
    for(i=0; i<8; i++){
        printf("cc3.......%d%d%d\n", (G_3[i]>>2)&1, (G_3[i]>>1)&1, G_3[i]&1);
    }
    for(i=0; i<16; i++){
        printf("%d%d%d%d\n",(G_4[i]>>3)&1, (G_4[i]>>2)&1, (G_4[i]>>1)&1, G_4[i]&1);
    }
    for(i=0; i<32; i++){
        printf("%d%d%d%d%d\n",(G_5[i]>>4)&1,(G_5[i]>>3)&1, (G_5[i]>>2)&1, (G_5[i]>>1)&1, G_5[i]&1);
    }
...
*/
    do{
        ...
        case 5:
            ...
            continue;
        case 6:
            printf("%d%d%d%d%d%d\n", (G_6[k]>>5)&1, (G_6[k]>>4)&1, (G_6[k]>>3)&1, (G_6[k]>>2)&1, (G_6[k]>>1)&1, G_6[k]&1);
            continue;
        }*/
    }while(flag==0);
}
